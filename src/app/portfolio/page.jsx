  ...
  return (
    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex lg:h-screen h-screen gap-4 items-center overflow-hidden">
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <p className="w-80 md:w96 lg:w-[500px] lg:text-lg xl:w-[500px]">
                    {item.desc}
                  </p>
